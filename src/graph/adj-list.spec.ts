...
describe("Adjacency List", () => {
  let adjList: AdjacencyList<string>;
  beforeEach(() => {
    adjList = new AdjacencyList<string>(true);
  });
  ...
  describe("Insert Operation", () => {
    let unDirectedGraph: AdjacencyList<string>;
    beforeEach(() => {
  ...
  describe("Delete Edge Operation", () => {
    ...
    it("should return error while deleting edge D -> A", () => {
      expect((adjList.removeEdge("D", "A") as Error).message).toBe(
        "No edge present between D and A"
      );
    });

    describe("For undirectional Graph", () => {
      let undirectedList: AdjacencyList<string>;
      beforeEach(() => {
  ...
  describe("Delete Vertex Operation", () => {
    ...
    describe("For undirectional Graph", () => {
      ...
      it("should delete node C and also vertices A -> C and C -> A", () => {
        ...
        expect(
          undirectedList.vertices.get("A").lookup("C").hasVal
        ).toBeTruthy();
        expect(undirectedList.vertices.get("C").len).toBe(1);
        expect(
          undirectedList.vertices.get("C").lookup("A").hasVal
        ).toBeTruthy();
